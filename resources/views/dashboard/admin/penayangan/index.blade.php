    ...
    <div class="card-body">
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $penayangan->getId() }}</td>
                    <td>{{ $penayangan->getTheater() }}</td>
                    <td>{{ $penayangan->getDate() }}</td>
                    <td>{{ $penayangan->getTime() }}</td>
                    <td>{{ $penayangan->getMovie() }}</td>
                    <td>{{ $penayangan->getPrice() }}</td>
                    <td>
                        <a class="btn btn-primary" href="{{route('dashboard.admin.penayangan.edit', ['id'=> $penayangan->getId()])}}">
                            <i class="bi-pencil"></i>
                        </a>
